...
urlpatterns = [
    ...
    path("user/<int:owner:id>/create/<int:outfit_type>/", views.outfit_create, {"owner_type": "user"}, name="user_outfit_create"),
    path("child/<int:owner:id>/create/<int:outfit_type>/", views.outfit_create, {"owner_type": "child"}, name="child_outfit_create"),
